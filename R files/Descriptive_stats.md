...
Import your dataset and select a subsample with the function  ```r select()```.  In my case, I import the ESS 8 and I use the ```.dta``` version of it, which is the version in STATA. 
```r
