...
To create a function, the first step is to open the Rprofile file. An Rprofile file is a text file (ending in `.R`) where you write and save your R code, allowing you to edit, reuse, and run it later. You can open your Rprofile file by simply writing this prompt in Rstudio:
...
Once your Rprofile file is open, you can write your function. In this example, I am going to write a function for the `tabulate` command that I have presented in [How to Replicate STATA tabulate command: one-way and two-way tables](https://gubellom.github.io/tabulate/).
